...
export const SHELL_VERSION = 'stage4-shell-10';
...
export type OwnerData = { version: number; ownerId: string; deviceId: string; nextSequence: number; prepared: Prepared | null; sessions: Session[]; queue: Operation[]; pendingPin?: Operation; lastSyncAt: string | null; testOffline?: boolean };
