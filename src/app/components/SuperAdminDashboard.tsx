...
> = {
  healthy: {
    label: "Healthy",
    bgClass: "bg-emerald-50 dark:bg-emerald-500/15 text-emerald-700 dark:text-emerald-400 border-emerald-100 dark:border-emerald-500/30",
  ...
  warning: {
    label: "Warning",
    bgClass: "bg-amber-50 dark:bg-amber-500/15 text-amber-700 dark:text-amber-400 border-amber-100 dark:border-amber-500/30",
  ...
  critical: {
    label: "Critical",
    bgClass: "bg-red-50 dark:bg-red-500/15 text-red-700 dark:text-red-400 border-red-100 dark:border-red-500/30",
  ...
  inactive: {
    label: "Inactive",
    bgClass: "bg-gray-50 dark:bg-white/[0.06] text-gray-600 dark:text-gray-400 border-gray-100 dark:border-white/[0.08]",
    textClass: "text-gray-600 dark:text-gray-400",
    borderClass: "border-gray-200 dark:border-white/[0.08]",
    dotClass: "bg-gray-400",
    badgeLabel: "INACTIVE",
  },
  new: {
    label: "New Account",
    bgClass: "bg-blue-50 dark:bg-blue-500/15 text-blue-700 dark:text-blue-400 border-blue-100 dark:border-blue-500/30",
